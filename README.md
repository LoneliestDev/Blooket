...
Make sure you're running it properly (see [How to use](https://github.com/LoneliestDev/Blooket#how-to-use)), if it still doesn't work and other cheats do, then [make an issue](https://github.com/05Konz/Blooket-Cheats/issues)
</details>
